...
bool loader(Emulator & emulator, string fname); /* basically called by the debugger, and the debugger is a member of an emulator
                                     and the emulator emulats a CPU :-)
                                     loads from the input .xme file
                                    */
