...
template <typename Type>
Double_node_tester<Type>::Double_node_tester(typename Double_sentinel_list<Type>::Double_node *obj) : Tester<typename Double_sentinel_list<Type>::Double_node>(obj) {
	// empty
}
...
void Double_node_tester<Type>::process() {
	if (command == "next") {
		...
		if (expected_value == actual_value) {
			...
			std::cout << ": Failure in value(): expecting '" << expected_value << "' but got '" << actual_value << "'" << std::endl;
		}
